...
const russianDictionary = {
  ...
  hero: {
    ...
    title: "Leader Audit: Ваша финансовая безопасность",
    titleAccent: "в эпоху тотального налогового контроля",
    description:
  ...
  expertise: {
    badge: "Почему мы",
    title: "Экспертность и надёжность",
    description:
  ...
  leadForm: {
    ...
    title: "Назначьте встречу с партнёром Leader Audit",
...
const dictionaries = {
  uz: {
    ...
    services: {
      ...
      cards: [
        {
          title: "Auditorlik xizmatlari",
          description:
            "Xalqaro standartlar va O'zbekiston Respublikasi qonunchiligiga muvofiq professional audit.",
          features: [
            "Majburiy audit",
            "Tashabbuskor audit",
            "MHXS bo'yicha hisobot auditi",
            "XHXS bo'yicha hisobot auditi",
            "Maxsus masala auditi",
          ],
        },
        {
          ...
          features: [
            "Hisob yuritish va tiklash",
            "Moliyaviy hisobot tayyorlash",
            "MHXSdan XHXSga transformatsiya",
            "Soliq va statistik hisobot",
            "Buxgalteriyani optimallashtirish",
          ],
        },
        {
          title: "Soliq konsaltingi",
        ...
        {
          title: "Autsorsing xizmatlari",
          description: "Nomutaxassis funksiyalarni professionallarga topshirish: xarajatni kamaytirish va samaradorlikni oshirish.",
          features: [
            "Buxgalteriya autsorsingi",
            "Kadrlar autsorsingi",
            "Ish haqi hisob-kitobi",
            "Elektron hujjat aylanishi",
            "Virtual assistent xizmati",
          ],
        },
      ],
    },
      ...
      cards: [
        ...
        },
        {
          ...
          features: [
            ...
            "Financial reporting",
            "Transformation from NAS to IFRS",
        ...
        },
        {
          ...
          features: [
            ...
            "Transfer pricing",
            "Business setup in Uzbekistan",
          ],
        },
        {
          title: "Outsourcing services",
          description: "Delegate non-core functions to professionals to reduce costs and increase efficiency.",
          features: [
